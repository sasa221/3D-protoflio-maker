-- Career Studio PR-5: private, local-only targeted CV drafts.
-- Job descriptions and company names are private data and are never exposed by
-- the public portfolio routes or Admin APIs.
