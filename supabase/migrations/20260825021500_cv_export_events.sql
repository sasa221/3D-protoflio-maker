...
-- The existing serverless endpoint uses a server-only client for ownership and quota
-- checks; it never reaches the browser. Keep this read-only for career data.
