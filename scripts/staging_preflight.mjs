...
const requiredNames = [
  ...
  'AUTH_REDIRECT_URL', 'ADMIN_EMAIL', 'ADMIN_EMAILS', 'CORS_ORIGINS', 'ALLOWED_ORIGINS',
  'BREVO_API_KEY', 'BREVO_SENDER_EMAIL', 'BREVO_SENDER_NAME', 'BREVO_REPLY_TO_EMAIL',
  'PAYMENT_INSTAPAY_ADDRESS', 'PAYMENT_INSTAPAY_BANK', 'PAYMENT_INSTAPAY_NAME',
  'PAYMENT_INSTAPAY_NOTE', 'PAYMENT_INSTAPAY_PHONE', 'ADMIN_NOTIFY_EMAIL',
  'VITE_ENABLE_BILLING_PORTAL', 'STRIPE_SECRET_KEY', 'PAYMOB_API_KEY',
  'VITE_SENTRY_DSN', 'SENTRY_AUTH_TOKEN', 'FF_CAREER_STUDIO',
  'FF_ENTITLEMENT_ENFORCEMENT_ENABLED', 'FF_FREE_FINALIZATION_LOCK_ENABLED',
  'FF_GROUP_MANAGEMENT_ENABLED', 'FF_HOSTING_PAYWALL_ENABLED', 'FF_MONETIZATION_UI_ENABLED',
  'FF_THEME_PAYWALL_ENABLED', 'CV_FREE_EXPORT_LIMIT', 'CV_VARIANT_LIMIT', 'PUBLIC_SITE_URL'
];
const failures = [];
