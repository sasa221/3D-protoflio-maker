async function check() {
  for (let i = 1; i <= 25; i++) {
    try {
      ...
      if (asset !== '/assets/index-BILdPQ1W.js' && asset !== '/assets/index-CxJj5vkH.js' && asset !== '/assets/index-DNPaSDcz.js' && asset !== '/assets/index-GCSbVwzy.js' && asset !== '/assets/index-Bo7lm4pa.js' && asset !== '/assets/index-P70ujDH-.js' && asset !== '/assets/index-DvJVj3c6.js') {
        console.log(`\n======================================================`);
